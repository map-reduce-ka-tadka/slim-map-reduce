...
public class SampleSort {
	...
	public String phaseOne(int clientId) throws IOException{
	...
	public static String phaseTwo(String concatSamples) {
	...
	public void phaseThree(String pivots, int ClientId){
